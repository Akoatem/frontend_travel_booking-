...
const SearchBar = () => {
    ...
    const searchHandle = async() =>{
        ...
        const res = await fetch(`${BASE_URL}/tours/search/getTourBySerach?city=${location}&distance=${distance}&maxGroupSize=${maxGroupSize}`)
  ...
  return (
    <Col lg="12">
      <div className="search__bar">
        <Form className='d-flex align-atem-center gap-4'>
